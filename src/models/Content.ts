export default class Content {
	...
	constructor($temperatura: string , $luminosidade: string , $umidade: string , $tempMax: string , $tempMin: string , $umidMax: string , $umidMin: string , $lumMax: string , $lumMin: string , $current_color: string , $status_buzzer: string ) {
